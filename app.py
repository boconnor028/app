...
def fetch_player_stats(date=GAME_DATE, selected_slate=None):
    ...
    if response.status_code == 200:
        ...
        excluded_players = ["Damion Baugh", "Jahlil Okafor", "David Roddy", "Patrick Baldwin Jr.", "Alex Len", "Skal Labissiere", "Markelle Fultz", "Jaylen Nowell", "Lonnie Walker IV", "Killian Hayes", "Jahmir Young", "Jalen Hood-Schifino", "Lamar Stevens", "Javonte Green", "Jalen McDaniels", "Bones Hyland", "Jalen Crutcher"]
