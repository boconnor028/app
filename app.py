...
def fetch_player_stats(date=GAME_DATE, selected_slate=None):
    ...
    if response.status_code == 200:
        ...
        excluded_players = ["Damion Baugh", "Jahlil Okafor", "Alex Len", "Markelle Fultz", "Jaylen Nowell", "Lonnie Walker IV", "Killian Hayes", "Jahmir Young", "Moses Brown", "Lamar Stevens", "Javonte Green", "Jalen McDaniels", "Bones Hyland", "Jalen Crutcher"]
